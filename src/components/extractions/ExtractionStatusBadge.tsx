import { getExtractionStatusLabelKey, type ExtractionStatus } from '../../services/core/extraction/types'
...
export function ExtractionStatusBadge({ status, t }: Props) {
  return (
    <span
    ...
    >
      {t(getExtractionStatusLabelKey(status))}
    </span>
  )
}
